    ...
    <section id='expertise' className='scroll-mt-12'>
      <div className='container'>
        <div className='text-center mb-8'>
          <h2 className='mb-6'>Racheal's Areas of Specialization</h2>
          <p className='text-lg font-normal max-w-2xl mx-auto'>
            Racheal specializes in providing tailored virtual assistance solutions that enhance productivity, streamline operations, and support business growth.
          </p>
        </div>
        {/*  */}
